function Sudoku(){
	...
	this.screenID;
	this.limit = 50;
	this.matrix = [[1, 2, 3, 	4, 5, 6, 	7, 8, 9],[7, 8, 9, 	1, 2, 3, 	4, 5, 6],[4, 5, 6, 	7, 8, 9, 	1, 2, 3],[2, 3, 4, 	5, 6, 7, 	8, 9, 1],[8, 9, 1, 	2, 3, 4, 	5, 6, 7],[5, 6, 7, 	8, 9, 1, 	2, 3, 4],[3, 4, 5, 	6, 7, 8, 	9, 1, 2],[9, 1, 2, 	3, 4, 5, 	6, 7, 8],[6, 7, 8, 	9, 1, 2, 	3, 4, 5]];
	this.idLastButton;
	this.nilaiPatokan;
